    ...
    MLoading.prototype={
        ...
        initElement:function () {
            ...
            if (barElement.length == 0) {
                barElement = $('<div class="mloading-bar" id="fcl_mloading_bar"><a href="/iphone2"><button type="button" >重拍</button></a></div>');
            ...
            if (textElement.length == 0) {
                textElement = $('<span class="mloading-text" id="fcl_zzc_span" style="color: black"></span>');
